...
nut.command.add("forums", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	 client:SendLua([[gui.OpenURL("https://scourgeroleplay.com/index.php")]])
	end
})
...
nut.command.add("discord", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	 client:SendLua([[gui.OpenURL("https://discord.gg/QME9nTK")]])
	end
})

nut.command.add("steamgroup", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	 client:SendLua([[gui.OpenURL("https://steamcommunity.com/groups/scourgeroleplay")]])
	end
})
...
nut.command.add("content", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	client:SendLua([[gui.OpenURL("https://steamcommunity.com/sharedfiles/filedetails/?id=2041855968")]])
	end
})

nut.command.add("combatguide", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	client:SendLua([[gui.OpenURL("https://scourgeroleplay.com/forums/index.php?threads/combat.25/")]])
	end
})