...
PANEL = {}
	...
	local background = Material("materials/fullimagebackpackui.png", "noclamp smooth")
	function PANEL:Paint(w, h)
		surface.SetMaterial(background)
		surface.SetDrawColor(color_white)
		surface.DrawTexturedRect(0, 0 - 120, w, h * 1.5)

		surface.DisableClipping(true)
		surface.SetMaterial(background)
		surface.SetDrawColor(color_white)
		surface.DrawTexturedRectUV(0, -15, w, 40, 0, 0, 1, 0.1)

		surface.DisableClipping(true)
		surface.SetMaterial(background)
		surface.SetDrawColor(color_white)
		surface.DrawTexturedRectUV(0, h, w, 40, 0, 0, 1, -0.1)
	end
