...
function SCHEMA:LoadFonts(font)
	...
	surface.CreateFont("nutChatFontWhisper", {
	    font = "Times New Roman",
		size = 14,
		weight = 1000,
		shadow = true
	...
	surface.CreateFont("nutChatFontYell", {
	    font = "Times New Roman",
		size = 24,
		weight = 1000,
		shadow = true
	...
	surface.CreateFont("nutChatFontScream", {
	    font = "Times New Roman",
		size = 30,
		weight = 1000,
		shadow = true
...
if ( nut.gui.char and !nut.gui.char:IsVisible() ) then
if NUT_CVAR_TERRORPROCESS:GetBool() then

ingame = {}
ingame["$pp_colour_addr"] = 32/255
ingame["$pp_colour_addg"] = 16/255
ingame["$pp_colour_addb"] = 16/255
ingame["$pp_colour_brightness"] = -1.20
ingame["$pp_colour_contrast"] = 1.71
ingame["$pp_colour_colour"] = 0.39
ingame["$pp_colour_mulr"] = 0
ingame["$pp_colour_mulg"] = 0
ingame["$pp_colour_mulb"] = 0
-- DrawSunbeams( 2, 2, 2, 2, 2 )
DrawColorModify( ingame ) 
DrawBloom( .79, 5, 12.27, 1.16, 0, .0, 255, 255, 255 )
DrawToyTown( 19, ScrH()/0.38 )
DrawSobel(0.54)
DrawSharpen(-1.06,8.61)
end
end
...
if ( nut.gui.char and !nut.gui.char:IsVisible() ) then
if NUT_CVAR_HORRORPROCESS:GetBool() then

ingame = {}
ingame["$pp_colour_addr"] = 75/255
ingame["$pp_colour_addg"] = 73/255
ingame["$pp_colour_addb"] = 55/255
ingame["$pp_colour_brightness"] = -1.72
ingame["$pp_colour_contrast"] = 1.44
ingame["$pp_colour_colour"] = 0.21
ingame["$pp_colour_mulr"] = 0
ingame["$pp_colour_mulg"] = 0
ingame["$pp_colour_mulb"] = 0
-- DrawSunbeams( 2, 2, 2, 2, 2 )
DrawColorModify( ingame ) 
DrawBloom( .50, .63, 12.27, 1.16, 0, .0, 255, 255, 255 )
end
end
...
NUT_CVAR_TERRORPROCESS = CreateClientConVar("nut_terrorprocess", 0, true, true)
NUT_CVAR_HORRORPROCESS = CreateClientConVar("nut_horrorprocess", 0, true, true)
...
function SCHEMA:SetupQuickMenu(menu)
	...
	menu:addSpacer()
		...
		local button = menu:addCheck("Horror Colors", function(panel, state)
		if (state) then
			RunConsoleCommand("nut_horrorprocess", "1")
		else
			RunConsoleCommand("nut_horrorprocess", "0")
		end
	end, NUT_CVAR_HORRORPROCESS:GetBool())
			
	menu:addSpacer()
	  
	  	local button = menu:addCheck("True Terror", function(panel, state)
		if (state) then
			RunConsoleCommand("nut_terrorprocess", "1")
		else
			RunConsoleCommand("nut_terrorprocess", "0")
		end
	end, NUT_CVAR_TERRORPROCESS:GetBool())
