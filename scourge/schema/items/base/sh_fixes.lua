				...
				if (client and IsValid(client)) then
					...
					if (curChar and curChar:getID() == charID) then
						...
						if (item.attribBoosts) then
							...
							if(math.random(0,4) == 0) then --20% chance of fixes sickness.
								char:setData("dis_fix", CurTime()) --fix sickness
								client:notify("Your bad habits have made you come down with unfixed sickness.")
								...
								timer.Simple(sicknessTime, --removes the sickness after awhile
									function()
										char:setData("dis_fix", nil) --removes fixes sickness
