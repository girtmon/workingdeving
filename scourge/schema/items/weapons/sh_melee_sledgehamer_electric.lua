...
ITEM.desc = "<color=0,255,0>Requires a Strength level of 30 to equip. This item is a HEAVY weapon class.</color> A rather heavy sledgehammer, fitted with specialized electric conductors. Upon a hit, most augments in the body will see themselves incapable of use for a turn."
