...
ITEM.desc = "<color=0,255,0>Requires a Strength level of 5 to equip. This item is a LIGHT weapon class.</color> An old wooden walking cane, woven with barbedwire."
